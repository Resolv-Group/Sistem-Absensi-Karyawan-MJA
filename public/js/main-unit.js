...
$(document).ready(function () {
    ...
    $("#statusFilter, #pengajianFilter, #startDate, #endDate").on(
        "change",
        fetchPekerja,
    );
...
// Global validation function for Unit Requirements
window.checkUnitRequirements = function (url, isComplete, updateUrl) {
    if (!isComplete) {
        Swal.fire({
