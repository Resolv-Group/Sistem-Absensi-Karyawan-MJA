...
<div x-data="{
    ...
    // Map of pkwt_id -> pekerja.status_aktif for current page
...
$watch('filterStatus', () => updateTable());" class="relative">
    ...
    <div
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6 relative">
            ...
            <!-- Wrapper Dropdown (x-data Alpine.js) -->
            <div x-data="{ open: false }" class="relative inline-block text-left w-full lg:w-auto">
                ...
                <button @click="open = !open" type="button" 
                    ...
                    <!-- Ikon Panah Bawah (berputar saat terbuka) -->
            ...
            <button type="button"
                ...
                class="w-full justify-center lg:w-auto px-4 py-2 bg-blue-600 text-white text-xs font-bold rounded-lg hover:bg-blue-700 transition flex items-center gap-2 shadow-sm">
                <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="rounded-b-2xl">
        ...
        <div
            class="px-4 sm:px-6 py-4 bg-gray-50/50 border-t border-gray-100
            ...
            <a href="{{ route('view.pkwt', $unit->id) }}"
                class="group inline-flex items-center justify-center gap-2
                    ...
                    text-blue-600 text-xs font-bold rounded-xl
    ...
    <div x-show="selectedItems.length > 0"
        ...
        class="fixed bottom-4 sm:bottom-8 left-1/2 -translate-x-1/2 z-40
            w-[calc(100%-1rem)] sm:w-[95%] max-w-3xl"
        x-cloak>
        ...
        <div
            ...
            <div class="hidden sm:flex items-center gap-2">
                ...
                {{-- Update Status --}}
                <form action="{{ route('bulk.update.pekerja') }}"
                    method="POST"
                    class="flex gap-2">
    ...
    <div x-show="showJabatanModal" class="fixed inset-0 z-[30] flex items-center justify-center p-4 sm:p-6" x-cloak>
        ...
        <div x-show="showJabatanModal" x-transition:enter="ease-out duration-300"
            ...
            <form action="{{ route('bulk.update.jabatan') }}" method="POST">
                ...
                <div class="px-6 py-4 bg-gray-50 flex items-center justify-end gap-3 rounded-b-2xl">
                    <button type="button" @click="showJabatanModal = false"
                        class="px-4 py-2 text-sm font-bold text-gray-500 hover:text-gray-700 transition">
                        Batal
                    </button>
                    <button type="submit"
