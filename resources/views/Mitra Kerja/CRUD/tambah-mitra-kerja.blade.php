            ...
            <div class="px-6 py-6 border-b border-gray-100 bg-gray-50/50">
                <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                    <div class="flex items-center gap-3">
                        ...
                        <h2 class="text-xl font-bold text-gray-900 block sm:hidden">Tambah Mitra Kerja</h2>
                    </div>
                    <div>
                        <h2 class="text-xl font-bold text-gray-900 hidden sm:block">Tambah Mitra Kerja</h2>
                        <p class="text-sm text-gray-500 mt-1 sm:mt-0">Lengkapi data identitas perusahaan dan status kontrak.</p>
                    </div>
                </div>
            </div>
