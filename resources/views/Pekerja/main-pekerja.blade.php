...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
        ...
        <div class="bg-gray-100 p-1 rounded-lg inline-flex">
            <button class="bg-white shadow-sm px-3 py-1.5 rounded-md text-sm font-medium text-gray-800 flex items-center gap-2">
        ...
        <div class="flex flex-1 justify-end items-center gap-3">
            ...
            {{-- Add Button --}}
            <a href="{{route('view.tambah.pekerja')}}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-xs text-gray-500">Bergabung: {{formatTanggal($p->tgl_bergabung)}}</div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-xs text-gray-500">
                                <span class="block">NIK: <span class="text-gray-700 font-medium">{{ $p->nik }}</span></span>
                                <span class="block mt-0.5">KK : <span class="text-gray-700 font-medium">{{ $p->no_kk }}</span></span>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            @if($p->status_aktif == 1)
                                <span class="inline-flex px-3 py-1 text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800 border border-green-200">
                                    Aktif
                                </span>
                            @else
                                <span class="inline-flex px-3 py-1 text-xs leading-5 font-semibold rounded-full bg-red-50 text-red-600 border border-red-200">
                                    Tidak Aktif
                                </span>
                            @endif
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('view.detail.pekerja', $p->id) }}" class="text-blue-600 hover:text-blue-900 border border-blue-200 hover:bg-blue-50 rounded-lg px-3 py-1.5 transition">
                                Detail
                            </a>
                        </td>
                    </tr>
