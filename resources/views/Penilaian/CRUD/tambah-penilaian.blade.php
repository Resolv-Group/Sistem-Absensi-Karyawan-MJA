                                    ...
                                    <div
                                        ...
                                        <div
                                            class="flex
                                                ...
                                                gap-5 sm:gap-6
                                                pt-4 sm:pt-0
                                                border-t border-gray-50 sm:border-0">
                    ...
                    <div
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                            ...
                            <div class="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto order-1 sm:order-2">
                                ...
                                <button type="button"
                                    id="btnSimpan"
                                    class="w-full sm:w-auto px-8 py-3 bg-emerald-600 hover:bg-emerald-700
