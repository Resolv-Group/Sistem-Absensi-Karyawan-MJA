                        ...
                        <div class="relative">
                            <button @click.stop="openPenilaian = !openPenilaian"
                                ...
                                <svg class="w-4 h-4 text-gray-400 group-hover/btn:text-blue-500 transition-transform"
                                    :class="openPenilaian ? 'rotate-180' : ''" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3"
                                        d="M19 9l-7 7-7-7" />
                                </svg>
                            ...
                            <div x-show="openPenilaian" x-transition:enter="transition ease-out duration-200"
                                ...
                                @click.outside="openPenilaian = false"
                                ...
                                @foreach ($penilaians->skip(1) as $p)
                                    ...
                                    <a href="{{ route('view.ubah.penilaian', ['penilaianId' => $p->id, 'unitId' => $pkwt->id_unit, 'pekerjaId' => $first->id_pekerja]) }}"
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    @if ($first->status_hrd == 1)
                                                        <div
                                                            ...
                                                            <span
                                                                class="text-[10px] font-black text-emerald-600 uppercase">Sudah
                                                                Ditinjau</span>
                                                        </div>
                                                    @else
                                                        <div
                                                            class="flex items-center gap-1 bg-gray-50 px-1.5 py-0.5 rounded border border-gray-100">
                                                            <span
                                                                class="w-1 h-1 rounded-full bg-gray-300 animate-pulse"></span>
                                                            <span
                                                                class="text-[10px] font-black text-gray-400 uppercase">Belum
                                                                Ditinjau</span>
                                                        </div>
                                                    @endif
                                                </div>
                                        ...
                                        <div
                                            class="px-2.5 py-1 rounded-lg border {{ $subGrade['class'] }} font-black text-xs">
                                            {{ $subGrade['label'] }}
                                        </div>
                                    </a>
                                @endforeach
