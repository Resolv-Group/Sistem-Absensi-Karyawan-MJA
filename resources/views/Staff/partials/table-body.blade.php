        ...
        <td class="px-6 py-4 whitespace-nowrap">
            <div class="flex flex-col gap-1">
                ...
                <div class="flex items-center text-sm text-gray-900 font-medium">
                    ...
                    {{ $s->tgl_bergabung ? \Carbon\Carbon::parse($s->tgl_bergabung)->translatedFormat('d F Y') : '-' }}
                </div>
                ...
                <div class="flex items-center text-xs text-gray-500">
                    ...
                    {{ $s->tgl_bergabung ? \Carbon\Carbon::parse($s->tgl_bergabung)->diffForHumans(null, true) . ' bekerja' : '-' }}
