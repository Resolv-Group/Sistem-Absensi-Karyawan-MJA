...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        ...
        <div
            ...
            <div class="flex justify-between items-start z-10 relative">
                <div>
                    ...
                    <h3 class="text-3xl font-extrabold text-gray-900">{{ $totalStaff }}</h3>
                </div>
                <div
        ...
        <div
            ...
            <div class="flex justify-between items-start z-10 relative">
                <div>
                    <p class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Staff Baru</p>
                    <div class="flex items-baseline gap-2">
                        <h3 class="text-3xl font-extrabold text-gray-900">{{ $staffBaru }}</h3>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 relative">
        ...
        <div class="flex flex-1 justify-end items-center gap-3">
            ...
            @if(auth()->check() && auth()->user()->role === 'admin')
                <form action="{{ route('staff.import') }}" method="POST" enctype="multipart/form-data" class="inline-block">
                    @csrf
