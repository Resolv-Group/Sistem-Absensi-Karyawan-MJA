                    ...
                    <div class="md:col-span-9 grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="id_staff" maxlength="16" autocomplete="off"
                                value="{{ old('id_staff', $staff->id_staff) }}"
                        ...
                        <div class="sm:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="text" name="kpj" maxlength="11" autocomplete="off"
                                    ...
                                    placeholder="11 Digit Angka" value="{{ old('kpj', $staff->kpj) }}">
                            ...
                            <div>
                                ...
                                border-gray-500 bg-gray-50 text-gray-900 py-2.5 px-3 sm:text-sm font-medium placeholder-gray-400 focus:bg-white focus:border-blue-600 focus:ring-2 focus:ring-blue-100 focus:ring-offset-0 transition"
                                    placeholder="13 Digit Angka" value="{{ old('naker', $staff->naker) }}">
                                @error('naker')
                            ...
                            <div>
                                ...
                                border-gray-500 bg-gray-50 text-gray-900 py-2.5 px-3 sm:text-sm font-medium placeholder-gray-400 focus:bg-white focus:border-blue-600 focus:ring-2 focus:ring-blue-100 focus:ring-offset-0 transition"
                                    placeholder="16 Digit Angka" value="{{ old('no_kk', $staff->no_kk) }}">
                                @error('no_kk')
                                    <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
            ...
            <div class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-1">Nama Perusahaan PT<span
                                    class="text-red-500 font-semibold">*</span></label>
            ...
            <div class="sm:col-span-2 p-8">
                    <div class="flex items-start gap-4 p-4 rounded-xl border border-gray-200 bg-gray-50/60 hover:border-blue-200 hover:bg-blue-50/30 transition-all">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer mt-0.5" title="Centang untuk mengizinkan login">
                            <input type="checkbox" name="akses_login" id="akses_login_ubah" value="1"
                                class="sr-only peer"
                                @if(old('akses_login', optional($userAkun)->status_akun ?? 0)) checked @endif>
