...
@section('content')
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            {{-- LEFT COLUMN: PROFILE SUMMARY (Width: 4/12) --}}
            <div class="lg:col-span-4">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden sticky top-8">
                    ...
                    <div class="h-32 bg-gradient-to-br from-blue-600 to-blue-800 relative overflow-hidden">
                        <div class="absolute inset-0 opacity-10 pattern-grid-lg"></div> {{-- Optional pattern --}}
                    </div>

                    <div class="px-6 pb-8 text-center relative">
                        {{-- Avatar with White Ring --}}
                        <div class="relative -mt-16 mb-5 inline-block">
                            <div
                                class="h-32 w-32 rounded-full border-4 border-white shadow-md bg-white overflow-hidden mx-auto">
                                @if (Auth::user()->foto)
                                    <img src="{{ asset('storage/' . Auth::user()->foto) }}"
                                        class="w-full h-full object-cover">
                                @else
                                    <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=0D8ABC&color=fff&size=256"
                                        class="w-full h-full object-cover">
                                @endif
                            </div>
                            ...
                            {{-- Edit Photo Button --}}
                            <label
                                class="absolute bottom-1 right-1 bg-white text-gray-700 p-2 rounded-full border border-gray-200 shadow-sm cursor-pointer hover:bg-gray-50 hover:text-blue-600 transition-colors">
                        ...
                        <div class="grid grid-cols-2 gap-4 border-t border-gray-100 pt-6">
                            ...
                            <div class="text-center border-l border-gray-100">
                                <span class="block text-xs text-gray-400 uppercase tracking-wider font-semibold">Login
                                    Terakhir</span>
                                <span class="block text-sm font-semibold text-gray-700 mt-1">Hari ini</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {{-- RIGHT COLUMN: DETAILS & FORMS (Width: 8/12) --}}
            <div class="lg:col-span-8 space-y-8">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div
                                    class="px-4 py-3 bg-slate-50 rounded-lg border border-slate-100 text-gray-700 text-sm font-medium">
                                    {{ Auth::user()->name }}
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    {{-- Input Field --}}
                                    <input type="email" placeholder="contohemail123@example.com"
                                        value="{{ Auth::user()->staff->email ?? '' }}"
                ...
                <form action="#" method="POST"
                        ...
                        <div class="max-w-lg">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" onclick="togglePassword('current_password')"
                                    ...
                                    {{-- Icon Show (Eye) --}}
                                    <svg id="current_password-show" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                    ...
                                    {{-- Icon Hide (Eye Off) --}}
                                    <svg id="current_password-hide" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <button type="button" onclick="togglePassword('new_password')"
                                        class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600 focus:outline-none">
                                        <svg id="new_password-show" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <svg id="new_password-hide" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <button type="button" onclick="togglePassword('new_password_confirmation')"
                                        class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600 focus:outline-none">
                                        <svg id="new_password_confirmation-show" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <svg id="new_password_confirmation-hide" xmlns="http://www.w3.org/2000/svg"
                                            class="h-5 w-5 hidden" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex items-center justify-end gap-3">
                        <button type="button" class="text-sm font-medium text-gray-600 hover:text-gray-900 px-4 py-2">
                            Batal
                        </button>
                        <button type="submit"
                            class="inline-flex items-center justify-center px-6 py-2.5 border border-transparent text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 shadow-sm transition-all">
...
@section('scripts')
    ...
    <script>
        function togglePassword(inputId) {
            ...
            const iconShow = document.getElementById(inputId + '-show');
            const iconHide = document.getElementById(inputId + '-hide');
