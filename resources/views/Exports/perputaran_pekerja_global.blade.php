<table>
    ...
    <tr>
        <td style="font-weight: bold;">Cakupan :</td>
        <td style="font-weight: bold;">Keseluruhan Unit (Global)</td>
    </tr>
    <tr>
        <td></td>
        <td colspan="5" style="font-weight: bold; text-align: center; font-size: 14px;">Laporan Perputaran Karyawan Seluruh Unit</td>
    </tr>
    <tr></tr>

    <tr>
        <td style="font-weight: bold; text-align: center; border: 1px solid black;">No</td>
        <td style="font-weight: bold; text-align: center; border: 1px solid black;">Nama Unit</td>
    ...
    <!-- Baris Total -->
    <tr>
        <td colspan="2" style="text-align: right; font-weight: bold; border: 1px solid black;">Total Keseluruhan</td>
